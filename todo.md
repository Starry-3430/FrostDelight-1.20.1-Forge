    ...
    models\
      item\
        ...
        food\
          milk_popsicle.json
          apple_popsicle.json
          watermelon_popsicle.json
          sweet_berry_popsicle.json
          honey_popsicle.json
          vanilla_ice_cream.json
          chocolate_ice_cream.json
          sweet_berry_ice_cream.json
          watermelon_ice_cream.json
          honey_ice_cream.json
      block\
        machine\
          ice_cream_machine.json
          freezing_machine.json
          mixer.json
        food\
